package com.github.dmtest.support.element;
...
public class CustomHtmlElementDecorator extends HtmlElementDecorator {
    ...
    protected <T extends TypifiedElement> T decorateTypifiedElement(ClassLoader loader, Field field) {
        ...
        return CustomHtmlElementLoader.createTypifiedElement((Class<T>) field.getType(), elementToWrap, getElementName(field));
    }
        ...
        InvocationHandler handler = new TypifiedElementListNamedProxyHandler(elementClass, locator, name) {
            ...
            public Object invoke(Object o, Method method, Object[] objects) throws Throwable {
                ...
                for (WebElement element : locator.findElements()) {
                    ...
                    elements.add(CustomHtmlElementLoader.createTypifiedElement(elementClass, element, newName));
                }
    ...
    protected <T extends HtmlElement> T decorateHtmlElement(ClassLoader loader, Field field) {
        ...
        return CustomHtmlElementLoader.createHtmlElement((Class<T>) field.getType(), elementToWrap, getElementName(field));
    }
